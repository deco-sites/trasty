...
export default defineApp(async (_req, ctx) => {
  ...
  `
        ...
        'https://metrics.trasty.io/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
      ...
      {/* Rest of Preact tree */}
      <ctx.Component />
      <noscript><iframe src="https://metrics.trasty.io/ns.html?id=GTM-NP7Q86QP" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    </>
  );
});
