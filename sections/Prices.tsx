                    ...
                    {cards?.map((card, index) => (
                        ...
                        >
                            ...
                            <div class="bg-base-300 pt-6 pb-8 px-4 rounded-b-xl shadow-lg">
                                ...
                                <a href={card.buttonLink} class="btn py-3 mx-auto text-black font-bold text-sm bg-[#FCCC6B] rounded-[10px] w-full flex items-center justify-center">{card.buttonText}</a>
                            </div>
                        </Slider.Item>
                    ))}
                </Slider>
